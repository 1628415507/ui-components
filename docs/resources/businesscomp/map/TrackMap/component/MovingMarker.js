...
L.Marker.MovingMarker = L.Marker.extend({
    ...
    options: {
        ...
        loop: false,
        rotationAngle: 0,
        autoRotation: false, // 是否延道路自动设置角度
        progress: 0 //移动进度
    },
    ...
    stop: function (elapsedTime) {
        ...
        this._stopAnimation();
        console.log('【 elapsedTime 】-107', elapsedTime);
        // TODO:不传值点暂停再点停止会跳至下一段
        ...
        while (elapsedTime > lineDuration) {
            ...
            if (lineIndex >= this._latlngs.length - 1) {
                if (this.options.loop) {
                    ...
                    // console.log('【 stop-elapsedTime 】-268', elapsedTime);
                    this.stop(elapsedTime);
                    // console.log('【 进度结束 】-275');
                    this.progress = 1; //进度结束
                    return null;
                }
            }
    ...
    setRotationAngle: function (px1, py1, px2, py2) {
        // console.log('【 px1, py1, px2, py2 】-282', px1, py1, px2, py2);
        let x = px2 - px1;
        let y = py2 - py1;
        ...
        // console.log('【 angle 】-299', angle);
        this.update(); // 更新图标位置和角度
        return this;
    },
    // 标识移动所调用的方法

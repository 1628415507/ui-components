 ...
 * @LastEditTime: 2025-04-24 20:38:48
-->
<template>
  <!-- 整数 -->
...
const emit = defineEmits<InputNumberEmits>() //已经使用InputNumberEmits，就不需要再传入内容，否则会报错
//  这样会报错const emit = defineEmits<InputNumberEmits>(['update:modelValue', 'change'])
